...
CFS-PML scheme for fractional viscoacoustic simulation (Amax=0.0 standard PML, Memory Length L = 300)
...
int main(int argc, char* argv[]) 
{
	...
	float Vmax=3000.0;
	float Gmax=1.0;
	float Amax=0.0;//1.0*pi*f0; // if Amax=0, the CFS-PML reduces to standard PML 
