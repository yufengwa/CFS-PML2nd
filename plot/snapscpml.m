...
fp1=fopen('../cfspml2nd/output/visco_1_1_snapshots1_800.dat','rb');
snap1=fread(fp1,[NZ NX],'float');
fclose(fp1);

fp2=fopen('../cfspml2nd/output/visco_1_1_snapshots1_1600.dat','rb');
snap11=fread(fp2,[NZ NX],'float');
fclose(fp2);


fp3=fopen('../cfspml2nd/output/visco_1_1_snapshots1_2800.dat','rb');
snap111=fread(fp3,[NZ NX],'float');
fclose(fp3);


fp4=fopen('../cfspml2nd/output/visco_1_1_snapshots1_4800.dat','rb');
snap1111=fread(fp4,[NZ NX],'float');
fclose(fp4);

fp5=fopen('../cfspml2nd/output/visco_1_1_snapshots1_6800.dat','rb');
...
figure;
    ...
    print ./Fig/cpmlsnapmar1.eps -depsc2 -r600;
...
figure;
    ...
    set(gcf,'PaperUnits','inches','PaperPosition',[0 0 6.4 2.8]);
    print ./Fig/cpmlsnapmar2.eps -depsc2 -r600;
...
figure;
    ...
    set(gcf,'PaperUnits','inches','PaperPosition',[0 0 6.4 2.8]);
    print ./Fig/cpmlsnapmar3.eps -depsc2 -r600;
...
figure;
    ...
    set(gcf,'PaperUnits','inches','PaperPosition',[0 0 6.4 2.8]);
    print ./Fig/cpmlsnapmar4.eps -depsc2 -r600;
...
figure;
    ...
    set(gcf,'PaperUnits','inches','PaperPosition',[0 0 6.4 2.8]);
    print ./Fig/cpmlsnapmar5.eps -depsc2 -r600;    